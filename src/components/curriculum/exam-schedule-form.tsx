...
export function ExamScheduleForm({
  ...
  const [borderScoreType, setBorderScoreType] = useState<
  ...
  useEffect(() => {
    if (open) {
      ...
      setPreferenceOrder(
        initialData?.preference_order != null
          ? String(initialData.preference_order)
          : "",
      );
      setBorderScore(
        initialData?.border_score != null
          ? String(initialData.border_score)
          : "",
      );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {isEdit ? t("editExamSchedule") : t("addExamSchedule")}
          </DialogTitle>
          <DialogDescription>
            {isEdit
              ? t("editExamScheduleDescription")
              : t("addExamScheduleDescription")}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setPreferenceOrder(sanitizeHalfWidthDigits(e.target.value))
                }
            ...
            <div>
              ...
              <div className="flex gap-1.5">
                <Select
                  value={borderScoreType}
                  onValueChange={(v) =>
                    setBorderScoreType(v as "deviation" | "percentage")
                  }
                >
                  ...
                  <SelectContent>
                    <SelectItem value="deviation">
                      {t("borderTypeDeviation")}
                    </SelectItem>
                    <SelectItem value="percentage">
                      {t("borderTypePercentage")}
                    </SelectItem>
                  </SelectContent>
                </Select>
                <Input
                  ...
                  value={borderScore}
                  onChange={(e) =>
                    setBorderScore(sanitizeNumeric(e.target.value))
                  }
