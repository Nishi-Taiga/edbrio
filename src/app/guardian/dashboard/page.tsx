    ...
    <ProtectedRoute allowedRoles={['guardian']}>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-slate-400">ご家庭の学習状況を確認しましょう</p>
        </div>
              ...
              <div className="space-y-4">
                {upcoming.map((b: Booking) => (
                  <div key={b.id} className="flex items-center justify-between p-4 border dark:border-brand-800/20 rounded-lg">
                    ...
                    <div>
                      {b.status === 'confirmed' ? (
                        <Badge variant="default" className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400">確定</Badge>
                      ) : (
        ...
        {progressData.length > 0 && (
          <div className="mt-8">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">学習進捗</h2>
